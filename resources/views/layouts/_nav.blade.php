    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    @if (Auth::check() && Auth::user()->is_news_unread && config('lorekeeper.extensions.navbar_news_notif'))
                        <a class="nav-link d-flex text-warning" href="{{ url('roll') }}"><strong>BreedingRoller</strong><i class="fas fa-bell"></i></a>
                    @else
                        <a class="nav-link" href="{{ url('roll') }}">BreedingRoller</a>
                    @endif
                </li>
                <li class="nav-item">
